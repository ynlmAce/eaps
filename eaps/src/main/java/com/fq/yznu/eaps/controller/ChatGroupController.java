...
public class ChatGroupController {
    ...
    @GetMapping("/{groupId}")
    @PreAuthorize("isAuthenticated()")
    public ResponseResult<Map<String, Object>> getGroupDetail(@PathVariable @NotNull(message = "群组ID不能为空") Long groupId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseResult<Void> dismissGroup(@PathVariable @NotNull(message = "群组ID不能为空") Long groupId) {
    ...
    public ResponseResult<Void> inviteToGroup(
            @PathVariable @NotNull(message = "群组ID不能为空") Long groupId,
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseResult<Void> leaveGroup(@PathVariable @NotNull(message = "群组ID不能为空") Long groupId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseResult<List<Map<String, Object>>> getGroupMembers(@PathVariable @NotNull(message = "群组ID不能为空") Long groupId) {
    ...
    public ResponseResult<Void> handleJoinGroupApply(
            @PathVariable @NotNull(message = "申请ID不能为空") Long applyId,
