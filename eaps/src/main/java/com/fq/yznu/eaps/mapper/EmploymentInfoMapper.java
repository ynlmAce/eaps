...
public interface EmploymentInfoMapper extends BaseMapper<EmploymentInfo> {
     ...
     * @return 专业就业统计数据
     */
    List<Map<String, Object>> countEmploymentByMajor(@Param("graduationYear") Integer graduationYear, @Param("collegeId") Long collegeId);
     ...
     * @return 班级就业统计数据
     */
    List<Map<String, Object>> countEmploymentByClass(@Param("graduationYear") Integer graduationYear, @Param("majorId") Long majorId);
} 